...
class Virtual_Assistant:
    ...
    def assistant(self):
        print('LOADING YOUR VIRTUAL AI ASSISTANT')
        ...
        speak("LOADING YOUR VIRTUAL AI ASSISTANT")
        wishMe()  
        while True:
            ...
            if "thank you" in statement or "stop" in statement:
                speak("Your Virtual AI Assistant is shutting down, GOOD BYE")
                print("Your Virtual AI Assistant is shutting down, GOOD BYE")
                break
